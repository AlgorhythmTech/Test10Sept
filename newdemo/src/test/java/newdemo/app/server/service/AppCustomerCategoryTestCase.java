...
public class AppCustomerCategoryTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("GHKNR5MW6I7wJANQIlkxfMOzTjpD0miYV0voXLfdloksG4mFvj");
    ...
    public void test2Update() {
        try {
            org.junit.Assert.assertNotNull(System.getProperty("AppCustomerCategoryPrimaryKey"));
            AppCustomerCategory appcustomercategory = appcustomercategoryRepository.findById(System.getProperty("AppCustomerCategoryPrimaryKey"));
            appcustomercategory.setCustomerCategory("gfSulu6ovRzEoOgYaIhFANPYYEgyApuA1gpaJ7YvC44SxzylOF");
    ...
    public void test3FindById() {
        try {
            org.junit.Assert.assertNotNull(System.getProperty("AppCustomerCategoryPrimaryKey"));
            appcustomercategoryRepository.findById(System.getProperty("AppCustomerCategoryPrimaryKey"));
        } catch (com.athena.framework.server.exception.repository.SpartanPersistenceException e) {
            org.junit.Assert.fail(e.getMessage());
        } catch (Exception e) {
            e.printStackTrace();
