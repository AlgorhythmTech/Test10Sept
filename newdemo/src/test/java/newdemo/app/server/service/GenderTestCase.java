...
public class GenderTestCase {
    ...
    public void test1Save() {
        try {
            ...
            gender.setGender("2hokPIUNcmvfTv2YWlkfj3y7yVPD5A06wY7ZIamfcSlQXJi3e3");
    ...
    public void test2Update() {
        try {
            org.junit.Assert.assertNotNull(System.getProperty("GenderPrimaryKey"));
            Gender gender = genderRepository.findById(System.getProperty("GenderPrimaryKey"));
            gender.setGender("yIrBlDeypkMJgfAdT9zEDjm4QMEkTP9ffjg0uchZasJ5Gms1VH");
    ...
    public void test3FindById() {
        try {
            org.junit.Assert.assertNotNull(System.getProperty("GenderPrimaryKey"));
            genderRepository.findById(System.getProperty("GenderPrimaryKey"));
        } catch (com.athena.framework.server.exception.repository.SpartanPersistenceException e) {
            org.junit.Assert.fail(e.getMessage());
        } catch (Exception e) {
            e.printStackTrace();
