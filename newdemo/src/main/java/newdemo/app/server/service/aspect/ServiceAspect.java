package newdemo.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* newdemo.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.service..*..*(..))")
    protected void allOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.service..get*(..))")
