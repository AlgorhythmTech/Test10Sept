package newdemo.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* newdemo.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* newdemo.app.server.repository..*(..))")
