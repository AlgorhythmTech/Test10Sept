package newdemo.app.server.businessservice.aspect;
...
public class BusinessAspect {
    ...
    @Before("execution(* newdemo.app.server.repository.*Impl.save(..))")
    public void beforeSaveAdvice(JoinPoint joinPoint) throws SpartanConstraintViolationException {
        Object obj[] = joinPoint.getArgs();
    }

    @After("execution(* newdemo.app.server.businessservice..*(..))")
